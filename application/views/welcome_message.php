...
<meta charset="utf-8">
<link rel="stylesheet" href="gudang/maskapai/css/reset.css" type="text/css" media="all">
<link rel="stylesheet" href="gudang/maskapai/css/layout.css" type="text/css" media="all">
<link rel="stylesheet" href="gudang/maskapai/css/style.css" type="text/css" media="all">
<script type="text/javascript" src="gudang/maskapai/js/jquery-1.5.2.js" ></script>
<script type="text/javascript" src="gudang/maskapai/js/cufon-yui.js"></script>
<script type="text/javascript" src="gudang/maskapai/js/cufon-replace.js"></script>
<script type="text/javascript" src="gudang/maskapai/js/Cabin_400.font.js"></script>
<script type="text/javascript" src="gudang/maskapai/js/tabs.js"></script>
<script type="text/javascript" src="gudang/maskapai/js/jquery.jqtransform.js" ></script>
<script type="text/javascript" src="gudang/maskapai/js/jquery.nivo.slider.pack.js"></script>
<script type="text/javascript" src="gudang/maskapai/js/atooltip.jquery.js"></script>
<script type="text/javascript" src="gudang/maskapai/js/script.js"></script>
<!--[if lt IE 9]>
...
<div class="main">
  ...
  <header>
    <div class="wrapper">
      <h1><a href="gudang/maskapai/index.php" id="logo">AirLines</a></h1>
      <span id="slogan">Fast, Frequent &amp; Safe Flights</span>
      <nav id="top_nav">
        <ul>
          <li><a href="gudang/maskapai/index.php" class="nav1">Home</a></li>
    ...
    <nav>
      <ul id="menu">
        <li id="menu_active"><a href="gudang/maskapai/index.php"><span><span>About</span></span></a></li>
        <li><a href="gudang/maskapai/offers.php"><span><span>Offers</span></span></a></li>
        <li><a href="gudang/maskapai/book.php"><span><span>Book</span></span></a></li>
        <li><a href="gudang/maskapai/services.php"><span><span>Services</span></span></a></li>
        <li><a href="gudang/maskapai/safety.php"><span><span>Safety</span></span></a></li>
        <li class="end"><a href="gudang/maskapai/contacts.php"><span><span>Contacts</span></span></a></li>
      </ul>
    </nav>
  </header>
  <!-- / header -->
  ...
  <section id="content">
    <div class="for_banners">
      ...
      <div id="slider"> <img src="gudang/maskapai/images/banner1.jpg" alt=""> <img src="gudang/maskapai/images/banner2.jpg" alt=""> <img src="gudang/maskapai/images/banner3.jpg" alt=""> </div>
    </div>
    <div class="wrapper pad1">
        ...
        <div class="box1">
          ...
          <div class="pad"> <strong>From Birmingham</strong><br>
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 143.-</span> <a href="gudang/maskapai/book2.php">Zurich</a> </li>
            </ul>
            <strong>From London City</strong><br>
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 176.-</span> <a href="gudang/maskapai/book2.php">Basel</a> </li>
              <li> <span class="right color1">from GBP 109.-</span> <a href="gudang/maskapai/book2.php">Geneva</a> </li>
            </ul>
            <strong>From London Heathrow</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 100.-</span> <a href="gudang/maskapai/book2.php">Geneva</a> </li>
              <li> <span class="right color1">from GBP 112.-</span> <a href="gudang/maskapai/book2.php">Zurich</a> </li>
              <li> <span class="right color1">from GBP 88.-</span> <a href="gudang/maskapai/book2.php">Basel</a> </li>
            </ul>
          </div>
          <h2>From Ireland To Switzerland</h2>
          <div class="pad"> <strong>From Dublin</strong><br>
            <ul class="pad_bot2 list1">
              <li class="pad_bot1"> <span class="right color1">from EUR 122.-</span> <a href="gudang/maskapai/book2.php">Zurich</a> </li>
            </ul>
          </div>
        </div>
      </article>
      <article class="col2">
        ...
        <div class="wrapper">
          <article class="cols">
            <figure><img src="gudang/maskapai/images/page1_img1.jpg" alt="" class="pad_bot2"></figure>
            <p class="pad_bot1"><strong>Airlines is one of free website templates created by TemplateMonster.com team.</strong></p>
            <p>This website template is optimized for 1024X768 screen resolution. It is also XHTML &amp; CSS valid. This website template has several pages: <a href="gudang/maskapai/index.php">About</a>, <a href="gudang/maskapai/offers.php">Offers</a>, <a href="gudang/maskapai/book.php">Book</a>, <a href="gudang/maskapai/services.php">Services</a>, <a href="gudang/maskapai/safety.php">Safety</a>, <a href="gudang/maskapai/contacts.php">Contacts</a>.</p>
          </article>
          <article class="cols pad_left1">
            <figure><img src="gudang/maskapai/images/page1_img2.jpg" alt="" class="pad_bot2"></figure>
